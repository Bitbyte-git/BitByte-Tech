...
export const openPositions = [
  ...
  },
  {
    ...
    mode: "On-site",
    description:
      "Work with AI tools to create, test, optimize, and document prompts for high-quality text, images, videos, marketing content, social media creatives, and business outputs.",
    experience: "0 Years",
    salary: "Stipend as per company policy.",
    suitableFor: [
      "Students",
    ...
    eligibility: [
      "Students, fresh graduates, or candidates from any relevant discipline can apply.",
      "Strong interest in Artificial Intelligence, creativity, digital marketing, technology, or content creation.",
      "Basic understanding of Generative AI and Prompt Engineering.",
      "Familiarity with ChatGPT or similar AI platforms.",
      "Good written communication skills.",
      "Creative thinking and strong attention to detail.",
      "Ability to clearly describe visual concepts, designs, scenes, and content requirements.",
      "Basic understanding of social media, digital marketing, graphic design, or content creation.",
      "Ability to research and learn new AI tools quickly.",
      "Strong experimentation and problem-solving skills.",
    ],
    responsibilities: [
      "Create effective prompts for AI tools such as ChatGPT, Gemini, Claude, Midjourney, DALL-E, Canva AI, and other generative AI platforms.",
      "Develop prompts for image generation, video generation, social media content, advertisements, posters, and marketing campaigns.",
      "Test different prompt structures and improve results through continuous experimentation.",
      "Optimize prompts for accuracy, creativity, consistency, brand style, and output quality.",
      "Create detailed prompts based on client requirements and reference materials.",
      "Work with design, marketing, and content teams to develop AI-assisted creative assets.",
      "Research new AI tools, prompt techniques, and generative AI trends.",
      "Maintain a structured library of reusable prompts and templates.",
      "Compare AI-generated outputs and identify areas for improvement.",
      "Assist in AI-powered content creation and workflow automation.",
      "Ensure generated content follows brand guidelines and project requirements.",
      "Document prompt versions, testing results, and successful approaches.",
    ],
    preferredExperience: [
      "Experience with AI image generation and AI video generation tools.",
      "Basic knowledge of Canva, Photoshop, or other design tools.",
      "Understanding of Instagram, Facebook, LinkedIn, and YouTube.",
      "Basic knowledge of digital marketing and advertising.",
      "Familiarity with prompt frameworks, AI automation, or no-code tools.",
      "Basic knowledge of Python or APIs is an added advantage but not mandatory.",
      "Curious, experimental, quick to learn, and passionate about improving creative and business workflows using AI.",
    ],
    skills: [
      "Prompt Engineering",
      "Generative AI",
